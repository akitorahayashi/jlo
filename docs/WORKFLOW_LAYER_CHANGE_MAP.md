...
- Mock recovery cleanup: `src/app/commands/workflow/workspace/clean/mock.rs`
...
- Add cleanup scope for new mock artifacts in `src/app/commands/workflow/workspace/clean/mock.rs`.
