...
fn mock_narrator_change_file_passes_doctor() {
    ...
    let mock_change = include_str!("../src/testing/assets/narrator_change.yml");
...
fn mock_observer_event_file_passes_doctor() {
    ...
    let mock_event = include_str!("../src/testing/assets/observer_event.yml");
    let events_dir = ctx
        .jules_path()
        .join("workstreams")
...
fn mock_decider_issue_file_passes_doctor() {
    ...
    let mock_issue = include_str!("../src/testing/assets/decider_issue.yml");
    let issues_dir = ctx
        .jules_path()
        .join("workstreams")
        .join("test-workstream")
