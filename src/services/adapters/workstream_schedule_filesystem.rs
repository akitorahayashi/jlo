...
pub fn load_schedule(store: &impl WorkspaceStore, workstream: &str) -> Result<WorkstreamSchedule, AppError> {
...
pub fn list_subdirectories(store: &impl WorkspaceStore, dir: &Path) -> Result<Vec<PathBuf>, AppError> {
